...
from constants_bgc import BOUND_VARS_MAP, PROG_VARS_MAP, TensorMap, construct_metadata
from datasets import InferenceDataset, InferenceDatasets, TrainDataset
from models.samudra_bgc import SamudraBGC
...
class Trainer:
    def __init__(self, cfg) -> None:
        ...
        if "samudra_bgc" == cfg.experiment.network:
            ...
            model = SamudraBGC(
                ...
                prognostic_vars=self.prognostic_vars,  # Add this
                non_negative_vars=cfg.unet.corrector.non_negative_corrector_names if   hasattr(cfg.unet, 'corrector') else None  # Add this
                ).to(self.device)
        else:
